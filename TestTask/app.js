...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RootFolder = __webpack_require__(168);

	var _RootFolder2 = _interopRequireDefault(_RootFolder);

	var _CatalogueTab = __webpack_require__(170);

	var _CatalogueTab2 = _interopRequireDefault(_CatalogueTab);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'main-context', id: 'left', __self: this
	          },
	          _react2.default.createElement(_RootFolder2.default, { catalogueTree: this.props.catalogueTree, __self: this
	          })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'main-context', id: 'right', __self: this
	          },
	          _react2.default.createElement(_CatalogueTab2.default, { catalogueTree: this.props.catalogueTree, __self: this
	          })
	        )
	      );
	    }
	...
	(0, _reactDom.render)(_react2.default.createElement(App, { catalogueTree: catalogueTree, __self: undefined
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RootFolder = function (_React$Component) {
	  _inherits(RootFolder, _React$Component);

	  function RootFolder() {
	    _classCallCheck(this, RootFolder);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(RootFolder).apply(this, arguments));
	  }

	  _createClass(RootFolder, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.catalogueTree.children.map(function (node) {
	            return _react2.default.createElement(_Node2.default, { catalogueTree: node, key: node.id, __self: _this2
	            });
	          })
	        ),
	        _react2.default.createElement('br', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Node = function Node(_ref) {
		var catalogueTree = _ref.catalogueTree;
		return _react2.default.createElement(
			'li',
			{ className: 'li-node', __self: undefined
			},
			catalogueTree.name
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabRow = __webpack_require__(171);
	...
	var CatalogueTab = function (_React$Component) {
	    _inherits(CatalogueTab, _React$Component);

	    function CatalogueTab() {
	        _classCallCheck(this, CatalogueTab);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CatalogueTab).call(this));
	    ...
	    _createClass(CatalogueTab, [{
	        ...
	        value: function render() {
	            ...
	            for (i = 0, max = list.length; i < max; i++) {
	                ...
	                var filteredNodes = this.props.catalogueTree.children.filter(function (node) {
	                    return node.name.toLowerCase().indexOf(_this2.state.search.toLowerCase()) !== -1;
	                });
	            }
	            return _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'search-box', __self: this
	                    },
	                    _react2.default.createElement(
	                        'span',
	                        {
	                    ...
	                    _react2.default.createElement('input', { id: 'search', type: 'text', value: this.state.search, onChange: this.updateSearch.bind(this), __self: this
	                    })
	                ),
	                _react2.default.createElement('br', {
	                    __self: this
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tab-row', __self: this
	                    },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'tab-data1', __self: this
	                        },
	                        '..'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'tab-data2', __self: this
	                        },
	                        ' '
	                    ),
	                    _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    filteredNodes.map(function (node) {
	                        return _react2.default.createElement(_TabRow2.default, { catalogueTree: node, key: node.id + 100, __self: _this2
	                        });
	                    })
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabRow = function (_React$Component) {
	    _inherits(TabRow, _React$Component);

	    function TabRow() {
	        _classCallCheck(this, TabRow);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TabRow).apply(this, arguments));
	    }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        ' ',
	                        this.props.catalogueTree.birthTime
	                    )
	                )
	            );
	        }
